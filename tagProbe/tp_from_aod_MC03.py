...
process.tagMuons = cms.EDFilter("PATMuonSelector",
    ...
    cut = cms.string("pt > 24 && abs(eta) < 2.1 && isPFMuon && isGlobalMuon && isTrackerMuon" # kinematics and muon type
                     ...
                     + " && !triggerObjectMatchesByPath('HLT_IsoMu24_eta2p1_v*', 1, 0).empty()" # IsoMu17 trigger matching
                    ),
)
...
process.tpTree = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    flags = cms.PSet(
        ...
        IsoMu24 = cms.string("!triggerObjectMatchesByPath('HLT_IsoMu24_eta24_v*', 1, 0).empty()"),
    ),
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("tptree_mc03.root"))
